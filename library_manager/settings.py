...
#defining the base dir using unipath
...
SECRET_KEY = 'jr==@x^m2jgddek5jj5z1w^c^r56)f(4%*=3yc8whka-ldjo8c'
...
TEMPLATES = [
    {
        ...
        'DIRS': [Path(__file__).resolve(strict=True).parent.parent.joinpath('templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
